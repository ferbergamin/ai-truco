...
class PlayerIA:
    ...
    def play(self, hand, opponent_card_weigth):
        ...
        cards_in_hand_weight = sum(cards_in_hand_weights)
        ...
        entries_trucar = [self.who_made_first, -self.cards_weight(self.opponent_cards_played), cards_in_hand_weight, hand]
